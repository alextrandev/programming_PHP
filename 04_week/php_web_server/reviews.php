...
<div id="review-container">
    ...
    -->
<?php 
foreach ($travel_reviews as $single_review) {
?>

    <section class="review">
        <h2 class="location"><?php print $single_review["location"]; ?></h2>
        <p class="author"><?php print $single_review["author"]; ?></p>
        <p class="date"><?php print $single_review["date"]; ?></p>
        <p class="comments"><?php print $single_review["comments"]; ?></p>
    </section>
